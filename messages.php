		    ...
		    //  $friend_value[$row['user_to']] = $row['value'];
		      ...
		      if($friend_value ==1){
         		...
         		<div class='col-sm-1'>
		      	...
		      	echo "    <li><input type='submit'  value='Decline' name='decline' style='display:none'; type='submit' class='btn btn-danger dec'><input type='submit' name='addfriend' value='Add Friend' id='$user_id' type='submit' class='btn btn-primary ad'><br>
                </form>
		        </ul>
         		</div>
         		<div class='col-sm-1'>
