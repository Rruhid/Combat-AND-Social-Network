...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$rand = rand(1, 2); //Random number between 1 and 3
		...
		$insert = "insert into users (f_name,l_name,user_name,describe_user,Relationship,user_pass,user_email,user_country,user_gender,user_birthday,user_image,user_cover,user_reg_date,status,posts,recovery_account,coordinates)
		values('$first_name','$last_name','$username','Salam Hamiya!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.','1')";
