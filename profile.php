...
<div class="row">
	...
	<div class="col-sm-8">
		<?php
			...
			<div id='profile-img'>
				<img src='users/$user_image' alt='Profile' class='img-circle' width='170px' height='185px'>
				<form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data'>
		...
		<?php
			...
			if(isset($_POST['submit'])){
				...
				if($u_cover==''){
					...
					$update = "update users set user_cover='$u_cover.$random_number' where id='$user_id'";
	...
	<?php
		if(isset($_POST['update'])){
				...
				if($u_image==''){
					...
					$update = "update users set user_image='$u_image.$random_number' where id='$user_id'";
...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: #e6e6e6;text-align: center;
	left:-1%;border-radius: 5px; margin-left: 20px;">
		<?php
		echo"
			...
			<p><strong>Elaqe Status: </strong> $Relationship_status</p><br>
			<p><strong>Yasayis yeri: </strong> $user_country</p><br>
			<p><strong>Qeydiyyat vaxti:</strong> $register_date</p><br>
			<p><strong>Xeylag: </strong> $user_gender</p><br>
			<p><strong>Dogum tarixi: </strong> $user_birthday</p><br>
		";
		?>
	</div>
	<div class="col-sm-6">
...
global $con;
$get_posts="select user_email from users where id='$u_id'";
